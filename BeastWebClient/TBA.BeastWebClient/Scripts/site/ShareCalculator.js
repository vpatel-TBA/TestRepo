...
var shareHtmlBox = '<div class="modal-content"><div class="modal-header" id="dvShareCalcHeader" style="cursor: move;">'
            ...
            + '<strong>Enter details to share this Application</strong>'
        + '</div>'
        + '<div class="modal-body">'
            + '<div class="textboxlabel">'
                + '<label class="emailTitle">Email :</label><label class="phoneTitle">Phone :</label>'
            + '</div>'
            + '<div id="dvMultiEmails">'
                + '<ul>'
                    + '<input type="text" style="text-align:left" id="txtEmailId" class="email-input-box" autofocus="" />'
                    + '<input type="text" style="text-align:right" id="txtPhoneNo" class="phone-input-box" autofocus="" />'
                + '</ul>'
            + '</div>'
        + '</div>'
        + '<div class="modal-footer"><label>eg. person@example.com, +919999999999</label>'
